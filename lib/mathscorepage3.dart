...
import 'package:brain_booster/mathlevel4.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_image_slideshow/flutter_image_slideshow.dart';


class MathScore3 extends StatelessWidget {
  late String score;

  MathScore3(this.score, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(backgroundColor: Colors.lightBlue,
            title: const Text('COOL LEVEL3 COMPLETED'),
            leading: GestureDetector(
              child: const Icon(Icons.arrow_back_ios_outlined),
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => MathScore3(score)));
              },
        ...
        floatingActionButton: FloatingActionButton(backgroundColor: Colors.lightBlue,
          ...
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => MathLevel4()));
        },
        )
    );
  }
